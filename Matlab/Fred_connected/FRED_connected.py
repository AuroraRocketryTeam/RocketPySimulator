...
impulse = solid_fred.I_total
t_burnout = solid_fred.t_burnout
grain_external_radius = solid_fred.D_ext/2
grain_internal_radius = solid_fred.D_int/2 
grain_length = solid_fred.L_single_grain
grain_volume = 3.14*((grain_external_radius**2)-(grain_internal_radius**2))*grain_length
grain_dens = solid_fred.rho_pr
grain_mass = grain_dens*grain_volume
thrust_curve =solid_fred.thrust_curve
...
analysis_parameters = {
    ...
    "motor_dry_mass": ((solid_fred.M_nozzle + solid_fred.M_tp + solid_fred.M_casing + solid_fred.M_nozzle_ring), 0.0001),
