...
weather_data: Literal['c','e','f','i','m'] = 'm'        #(Custom, Ensemble, Forecast, Isa, Manual) MODIFY f for normal test, `m` for inverted
...
elif weather_data == 'm': # MODIFY to perform inverted wind analysis, modifica magnitude ed heading in mdo da antare contro spettatori&case e trovare cosi il worst case di vento
    # Manual setting of the wind

    # Wind magnitude on the ground in (m/s)
    wind_magnitude_ground = 6                          # m/s, EuRoC limit is 8.7m/s on the ground
    # Heading of the wind from North in degrees
    wind_heading = 360                                  # degrees from North
