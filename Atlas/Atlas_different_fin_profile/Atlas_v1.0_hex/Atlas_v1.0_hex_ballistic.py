...
Env = Environment(
    date = (2025, 10, 13, 15),         #(Year, Month, Day, Hour)
...
# 2.1 Otherwise the EuRoC'25 3° Launch Day (The day Nemesis was launched) can be selected
Env.set_atmospheric_model(    
    type="Ensemble",                                                                                                  
    file=str(BASE_DIR / """environment_data/SantaMargarida_Ensemble_LaunchDayWeatherData.nc"""),                                        
